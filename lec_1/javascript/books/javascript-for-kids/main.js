...
console.log(longString.slice(30)); // ing and hard to read and hard to write                            
longString.slice(3, 15).length; // 11
longString.slice(3, 15)[0]; // l
...
let hasOranges = true;
let hasApples = false;
console.log(hasOranges || hasApples); 
...
let hasOrange = true;
let hadShower = true;
let shouldGoToSchool = !isWeekend && hadShower && (hasOrange || hasApples);
